...
- [ ] Commit the initial RetriCD code to git.
- [ ] Sync code to `zsh@10.154.22.11:~/RetriCD`.
- [x] Copy datasets from `~/ConceptSkillCDM/data` to `~/RetriCD/data`.
- [ ] Launch first `full` run on GPUs 2 and 3.
- [ ] Record remote log paths and first status check.
